...
namespace OAuth20.Server.Managers
{
    ...
    {
        private List<AppUser> AppUsers = new List<AppUser>() { new AppUser() { Id = new Guid("0031e891-cf4e-426e-b1da-1d7074a81e94").ToString(), UserName = "mbj@diviso.dk", Email = "mbj@diviso.dk" }, new AppUser() { Id = new Guid("abe1e891-cf4e-426e-b1da-1d7074a81e94").ToString(), UserName = "dev@diviso.dk", Email = "dev@diviso.dk" } };
